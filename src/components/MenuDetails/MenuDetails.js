    ...
    <>
      <div class="drawer drawer-end absolute">
        ...
        <div class="drawer-side">
          <label for="my-drawer-4" class="drawer-overlay relative"></label>
          <div class="menu p-4 overflow-y-auto w-80 bg-base-100 text-base-content font-mono">
            <h1 className='font-bold text-2xl mb-2 mr-40'>Your Cart</h1>
            <hr />
            <div className='flex'>
      ...
      <div class="text-gray-600 body-font px-12 pt-20 font-mono relative bg-transparent">
