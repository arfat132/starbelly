...
const Faq = () => {
  return (
    <div>
      ...
      <h1 className='lg:text-5xl text-2xl mb-12 font-mono font-bold text-center text-white mt-[-94px]  lg:mt-[-160px] md:mt-[-94px]'>Frequently Asked Questions</h1>
      <section className="bg-white px-12 lg:mt-16 ">
        <div className="container px-6 py-16 mx-auto">
          <div className="grid grid-cols-1 gap-8 lg:mt-16 md:grid-cols-2 xl:grid-cols-3">
            <div>
              <div className="inline-block p-3 text-white bg-red-700 rounded-lg">
