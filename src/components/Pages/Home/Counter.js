...
const Counter = () => {
    return (
        <div class="hero my-10 lg:py-0 py-28 h-full lg:h-[450px] bg-[url(https://i.ibb.co/KrwghrH/cc.png)] lg:bg-[url(https://i.ibb.co/tP5dvP4/footer1.png)]">
            <div class="flex flex-wrap text-center m-0 lg:m-6 w-full text-white">
                <div class="lg:w-1/5 w-full lg:p-24 px-36 py-8 lg:pt-0 pt-16 lg:py-0 text-center">
                ...
                <div class="lg:w-1/5 w-full lg:p-24 px-36 py-8 lg:py-0 text-center">
                    <div className='bg-red-700 py-6 border-2 border-white rounded-full'>
                ...
                <div class="w-full lg:p-24 px-36 lg:w-1/5 py-8 lg:py-0">
                    <div className='bg-red-700 py-6 border-2 border-white rounded-full'>
                ...
                <div class="w-full lg:p-24 px-36 py-8 lg:py-0 lg:w-1/5">
                    <div className='bg-red-700 py-6 border-2 border-white rounded-full'>
