        ...
        <>
            <div class="navbar bg-base-100 lg:px-20 sm:px-0 fixed top-0 shadow-md z-50">
                <div class="navbar-start">
                    ...
                    <Link to="/" class="btn btn-ghost normal-case text-xl font-bold text-red-800"><img src={logo} alt="" /></Link>
                </div>
                <div class="navbar-end hidden lg:flex">
                    <ul class="menu menu-horizontal p-0 text-xl font-bold uppercase text-red-800 font-mono py-2">
                        <li> <Link to="/" className="block py-3 pr-4 pl-3 hover:bg-red-700 hover:text-white" >Home</Link></li>
                        <li><Link to="/shop" className="block py-3 pr-4 pl-3 hover:bg-red-700 hover:text-white">Shop</Link></li>
                        <li><Link to="/blogs" className="block py-3 pr-4 pl-3 hover:bg-red-700 hover:text-white">Blog</Link></li>
                        <li><Link to="/faq" className="block py-3 pr-4 pl-3 hover:bg-red-700 hover:text-white">FAQ</Link></li>
                        ...
                        <div class="flex-none z-99">
                            <div class="dropdown dropdown-end">
                                ...
                                <ul tabindex="0" class="menu menu-compact dropdown-content mt-8 p-2 shadow bg-gray-100 rounded-box w-52">
                                    <li> {
                                        user?.uid ?
